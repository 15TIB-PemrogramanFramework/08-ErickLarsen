...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url()."assets/css_home/"; ?>css/flexslider.css" type="text/css" media="screen" />  <!-- flexslider-CSS --> 
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-right">
							<ul class="nav navbar">
								<li><a href="<?php echo site_url('btravel/home');?>" class="active">Home</a></li>
						...
						<ul class="slides">
							<li>
								<div class="banner-w3lstext">  
									<h2>MURAH</h2>
									<p>Harga paket yang lebih murah dibanding tempat lain</p>	
								</div>
							</li>
							<li>
								<div class="banner-w3lstext">  
									<h3>PELAYANAN TERBAIK</h3> 
									<p>Best costumer service merupakan hal yang paling kami utamakan</p>	
								</div>
							</li>
							<li>
								<div class="banner-w3lstext">  
									<h3>CEPAT DAN GAMPANG</h3> 
									<p>Seluruh pemesanan dan konfirmasi dapat dilakukan melalui website </p>	
								</div>
							</li>
						</ul> 
					</div> 	 
...
}else
{
	...
	<!-- //js -->
	<!-- FlexSlider --> 
	<script defer src="<?php echo base_url()."assets/css_home/"; ?>js/jquery.flexslider.js"></script>
	<script type="text/javascript">
