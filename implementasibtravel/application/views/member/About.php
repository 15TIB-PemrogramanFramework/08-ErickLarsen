					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-right">
							<ul class="nav navbar">
								...
								<li><a href="<?php echo site_url('btravel/about');?>" class="active">About</a></li> 
		...
		<div class="container">   
			...
			<div class="w3-welcome-grids">
				<div class="col-md-3 col-xs-6 w3l-welcome-grid"> 
					<img src="<?php echo base_url()."assets/css_home/"; ?>images/img1.jpg" alt=" " class="img-responsive"/>   
					<div class="agileits-welcome-info">
						<h4>CEPAT</h4>
						<p>Kami cepat dalam menerima pemesanan.</p>
					</div>
				</div>
				<div class="col-md-3 col-xs-6 w3l-welcome-grid">
					<img src="<?php echo base_url()."assets/css_home/"; ?>images/img2.jpg" alt=" " class="img-responsive"/>   
					<div class="agileits-welcome-info">
						<h4>MURAH</h4>
						<p>Harga yang kami tawarkan tentunya lebih murah dibanding tempat lain.</p>
					</div>
				</div>
				<div class="col-md-3 col-xs-6 w3l-welcome-grid">
					<img src="<?php echo base_url()."assets/css_home/"; ?>images/img3.jpg" alt=" " class="img-responsive"/>   
					<div class="agileits-welcome-info">
						<h4>BERKUALITAS</h4>
						<p>Tempat tempat yang kami ajukan dipaket adalah tempat tempat yang berkualitas.</p>
					</div>
				</div>
				<div class="col-md-3 col-xs-6 w3l-welcome-grid">
					<img src="<?php echo base_url()."assets/css_home/"; ?>images/img4.jpg" alt=" " class="img-responsive"/>   
					<div class="agileits-welcome-info">
						<h4>NYAMAN</h4>
						<p>Armada perjalanan yang kami gunakan memiliki fasilitas yang sangat lengkap.</p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div> 
...
<div class="footer w3-w3layouts">
	...
	<script type="text/javascript" src="<?php echo base_url()."assets/css_home/"; ?>js/numscroller-1.0.js"></script>
	<!-- //Progressive-Effects-Animation-JavaScript -->
