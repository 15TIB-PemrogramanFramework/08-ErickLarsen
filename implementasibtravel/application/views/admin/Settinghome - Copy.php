...
<head>
	...
	<!-- jQuery -->
	<script src="<?php echo base_url()."assets/css_setting/"; ?><?php echo base_url()."assets/css_setting/"; ?>js/jquery-2.1.4.min.js"></script>
	<!-- //jQuery -->
...
<body>
	<div class="page-container">
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu" >
					<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Home</span><div class="clearfix"></div></a></li>



					<li><a href="gallery.html"><i class="fa fa-picture-o" aria-hidden="true"></i><span>Paket Tour</span><div class="clearfix"></div></a></li>
					<li><a href="tabels.html"><i class="fa fa-table"></i>  <span>List</span><span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
						<ul>
							<li><a href="input.html">Booking</a></li>
							<li><a href="validation.html">Komentar</a></li>
							<li><a href="validation.html">Member</a></li>
							<li><a href="validation.html">Konfirmasi</a></li>
						</ul>
					</li>
