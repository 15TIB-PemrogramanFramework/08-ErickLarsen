			...
			<div class="mother-grid-inner">
				...
				<div class="header-main">
					<div class="logo-w3-agile">
						<h1><a href="index.html">SETTING</a></h1>
						...
						<div class="profile_details w3l">		
							<ul>
								<li class="dropdown profile_details_drop">
									...
									<ul class="dropdown-menu drp-mnu">
										<li> <a href="<?php echo site_url('login/logout'); ?>"><i class="fa fa-sign-out"></i> Logout</a> </li>
										<li> <a href="<?php echo site_url('Btravelmember/update'); ?>"><i class="fa fa-sign-out"></i> Pengaturan</a> </li>
									</ul>
								</li>
							</ul>
						</div>
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="<?php echo site_url('btraveladmin/settinghome');?>">Home</a><i class="fa fa-angle-right"></i>Pengaturan</li>
				</ol>
						...
						<div class="w3l-table-info">
							...
							<form action="<?php echo $aksi ?>" method="POST" enctype="multipart/form-data">
								<div class="form-group">
									<label>Email : </label>
									<input type="text" name="email_member" class="form-control" placeholder="Inputkan email" required value="<?php echo $email_member; ?>">
								</div>
								<div class="form-group">
									<label>Password : </label>
									<input type="password" name="password_member" class="form-control" placeholder="Inputkan password" required value="<?php echo $password_member; ?>">
								</div>
								<input type="hidden" name="username_member" required value="<?php echo $this->session->userdata('username')	; ?>">
