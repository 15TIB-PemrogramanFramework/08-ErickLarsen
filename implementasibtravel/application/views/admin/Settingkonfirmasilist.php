	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="<?php echo site_url('btraveladmin/settinghome');?>">Home</a><i class="fa fa-angle-right"></i>Konfirmasi</li>
				</ol>
									...
									<?php foreach ($konfirmasi as $key => $value) {
										...
										<tr>
											...
											<td>
												...
												<a href="<?php echo site_url('btravelkonfirmasi/download/'.$value->id_konfirmasi); ?> " class="btn btn-warning">
													<b>DOWNLOAD</b>
												</a>
