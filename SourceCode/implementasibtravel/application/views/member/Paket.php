	...
	<div class="agileits-banner">
		<div class="bnr-agileinfo"> 
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-right">
							<ul class="nav navbar">
								...
								<li><a href="<?php echo site_url('btravel/paket');?>" class="active">Paket</a></li> 
			...
			<div class="banner-text agileinfo about-bnrtext"> 
				<div class="container">
					<h2><a href="index.html">Home</a> / Paket</h2> 
				</div>
			</div>
			<!-- //banner-text -->   
		</div>
			...
			<div class="gallery-agileinfo">
				<ul class="w3gallery-grids">
					<?php foreach ($btravel as $key => $value) {
						?>
						<li>
							<a href="#" data-toggle="modal" data-target="#myModal<?php echo $value->id_paket; ?>">
								<img src="<?php echo site_url()?>assets/uploads/<?php echo $value->gambar; ?>" class="img-responsive" alt=""/>
						...
						<div class="modal fade" id="myModal<?php echo $value->id_paket; ?>" tabindex="-1" role="dialog" aria-labelledby="myModal<?php echo $value->id_paket; ?>" aria-hidden="true">
								...
								<div class="modal-content">
									<div class="modal-body modal-body-sub"> 
										<center>	
											...
											<br>
											<p><h2><?php echo $value->nama_paket; ?></h2></p>
											<p><h4><?php echo $value->harga_paket; ?></h4></p>
											<br>
											<p><h4>Rincian</h4></p>
											<p><?php echo $value->rincian_paket; ?></p>
											<br>
											<?php
											if(!empty($member) || !empty($admin)){
												?>
				...
				<script type="text/javascript" src="<?php echo base_url()."assets/css_home/"; ?>js/simple-lightbox.min.js"></script>
				<script>
					$(function(){
