	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="<?php echo site_url('btraveladmin/settinghome');?>">Home</a><i class="fa fa-angle-right"></i>Tambah</li>
				</ol>
						...
						<div class="w3l-table-info">
							...
							<form action="<?php echo $aksi?>" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="file" name="filefoto" class="form-control" placeholder="Inputkan gambar" value="">
								</div>
